...
export default function Footer() {
  return (
    <footer className="flex mt-12 px-12 text-center md:text-start mx-auto flex-col md:flex-row md:justify-between gap-4 md:gap-[40px] xl:gap-[196px]  w-full py-[2rem] lg:py-[5rem] text-white md:px-[60px] xl:px-[120px] bg-[url('./assets/images/footer.png')] bg-cover bg-no-repeat bg-blend-normal bg-[#004824] ">
